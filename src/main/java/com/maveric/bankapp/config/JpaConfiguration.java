package com.maveric.bankapp.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.maveric.bankapp.repository",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.maveric.bankapp.model" });
